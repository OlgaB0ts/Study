...
public class CardOperations {
    ...
    public static final Currency LOCALE_CURRENCY;
    public static final Locale LOCALE_BY;

    static {
        LOCALE_BY = new Locale("ru", "BY");
        LOCALE_CURRENCY = Currency.getInstance(LOCALE_BY);
    }
     ...
     */
    public static void replenish(CreditCard card, CurrencyValue value) {
        System.out.println("\nReplenish in process...");
        if (card.getBalance().isCurrencyEquals(value)) {
            card.getBalance().add(value);
            System.out.println(value.toString() + " transferred to account number " + card.getAccountNumber());
     ...
     */
    public static void withdraw(CreditCard card, CurrencyValue value) {
    ...
    private static void getBanknotes(CurrencyValue withdrawSum) {
        System.out.println("Take your money in amount: " + withdrawSum.toString());
    }

    public static CreditCard createCreditCard(long accountNumber, CurrencyValue value) {
        CreditCard creditCard = new CreditCard(accountNumber, value);
        System.out.println("Credit card created.\n" + creditCard.getInfo());
        return creditCard;
    }

    public static void printCardInfo(CreditCard card) {
        System.out.println("\nCard info:");
